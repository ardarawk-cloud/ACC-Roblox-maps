...
console.log('[Becak E-Bike] Built v1.45 + anti-blockout city polish v1.0 + organic city polish v1.4 + district polish v1.1 + cargo masterplan v1.4 + dedicated safety systems:',Buffer.byteLength(xml),'bytes');