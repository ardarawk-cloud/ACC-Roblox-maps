...
`playerData[player]=d\n    player:SetAttribute("BecakTrips",d.Trips)\n    player:SetAttribute("BecakVersion","1.6.0")\n    local stats=Instance.new("Folder")`,
'player attributes');
server += `\nWorkspace:SetAttribute("ACC_BecakRuntime","v1.6")\n`;
...
const xml=`<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.roblox.com/roblox.xsd" version="4"><External>null</External><External>nil</External><Item class="Workspace" referent="W"><Properties><string name="Name">Workspace</string></Properties></Item><Item class="Lighting" referent="L"><Properties><float name="Brightness">2.5</float><double name="ClockTime">8</double><string name="Name">Lighting</string></Properties></Item><Item class="ServerScriptService" referent="S"><Properties><string name="Name">ServerScriptService</string></Properties><Item class="Script" referent="B"><Properties><string name="Name">BecakEBike_Runtime</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(server)}]]></ProtectedString></Properties></Item><Item class="Script" referent="D"><Properties><string name="Name">BecakEBike_CityDetails</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(details)}]]></ProtectedString></Properties></Item><Item class="Script" referent="M"><Properties><string name="Name">BecakEBike_Masterplan</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(systems)}]]></ProtectedString></Properties></Item><Item class="Script" referent="V"><Properties><string name="Name">BecakEBike_VehicleMasterplan</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(vehicle)}]]></ProtectedString></Properties></Item><Item class="Script" referent="PL"><Properties><string name="Name">BecakEBike_Polish</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(polish)}]]></ProtectedString></Properties></Item><Item class="Script" referent="RA"><Properties><string name="Name">BecakEBike_RoadAccess</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(roadAccess)}]]></ProtectedString></Properties></Item></Item><Item class="StarterPlayer" referent="P"><Properties><string name="Name">StarterPlayer</string></Properties><Item class="StarterPlayerScripts" referent="PS"><Properties><string name="Name">StarterPlayerScripts</string></Properties><Item class="LocalScript" referent="C"><Properties><string name="Name">BecakEBike_Client</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(client)}]]></ProtectedString></Properties></Item><Item class="LocalScript" referent="MC"><Properties><string name="Name">BecakEBike_MasterplanClient</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(masterClient)}]]></ProtectedString></Properties></Item><Item class="LocalScript" referent="PH"><Properties><string name="Name">BecakEBike_DriverPhone</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(phoneClient)}]]></ProtectedString></Properties></Item><Item class="LocalScript" referent="MS"><Properties><string name="Name">BecakEBike_MobileSafeArea</string><bool name="Disabled">false</bool><ProtectedString name="Source"><![CDATA[${cdata(mobileSafe)}]]></ProtectedString></Properties></Item></Item></Item></roblox>`;
fs.writeFileSync(path.join(root,'maps/becak-e-bike/place.rbxlx'),xml);
console.log('[Becak E-Bike] Built v1.6 road-access + mobile safe-area + masterplan systems:',Buffer.byteLength(xml),'bytes');
