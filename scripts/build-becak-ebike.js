...
if(!cityDistrict.includes('ACC_BecakCityDistrictPolish","v1.0') || !cityDistrict.includes('BecakDistrictMaterialDepth","ON') || !cityDistrict.includes('BecakDiagonalRoofSilhouettes","ON') || !cityDistrict.includes('BecakRoundedBalconyRhythm","ON')) throw new Error('Becak district city polish v1.0 validation failed');
...
console.log('[Becak E-Bike] Built v1.45 + anti-blockout city polish v1.0 + organic city polish v1.4 + district polish v1.0 + cargo masterplan v1.4 + dedicated safety systems:',Buffer.byteLength(xml),'bytes');