...
console.log('[Becak E-Bike] Built v1.45 + anti-blockout city polish v1.0 + cargo masterplan v1.4 + dedicated safety systems:',Buffer.byteLength(xml),'bytes');