...
if(!cityOrganic.includes('ACC_BecakCityOrganicPolish","v1.3') || !cityOrganic.includes('BecakSideFacadeDepth","ON') || !cityOrganic.includes('BecakRoundedCornerArchitecture","ON') || !cityOrganic.includes('BecakOrganicMarketClusters","ON')) throw new Error('Becak organic city polish v1.3 validation failed');
...
console.log('[Becak E-Bike] Built v1.45 + anti-blockout city polish v1.0 + organic city polish v1.3 + cargo masterplan v1.4 + dedicated safety systems:',Buffer.byteLength(xml),'bytes');