...
if(!cityRealism.includes('ACC_BecakCityRealismUtilities\", \"v1.5') || !cityRealism.includes('BecakUtilityPoleNetwork\", \"ON') || !cityRealism.includes('BecakOverheadWireNetwork\", \"ON') || !cityRealism.includes('BecakRealisticRoadMarkings\", \"ON') || !cityRealism.includes('BecakFacadeMicroDepth\", \"ON')) throw new Error('Becak city realism utilities v1.5 validation failed');
