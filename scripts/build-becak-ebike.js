...
`playerData[player]=d\n    player:SetAttribute("BecakTrips",d.Trips)\n    player:SetAttribute("BecakVersion","1.8.0")\n    local stats=Instance.new("Folder")`,
'player attributes');
server += `\nWorkspace:SetAttribute("ACC_BecakRuntime","v1.8")\n`;
...
console.log('[Becak E-Bike] Built v1.8 curb access + left mobile UI + navigation + world QC:',Buffer.byteLength(xml),'bytes');
