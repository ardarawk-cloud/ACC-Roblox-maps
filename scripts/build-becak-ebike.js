...
console.log('[Becak E-Bike] Built v1.27 generic curb/trotoar seam hardening + runtime road-edge audit + v1.26 multi-probe recovery + left mobile UI + progression systems:',Buffer.byteLength(xml),'bytes');
