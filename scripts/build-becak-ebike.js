...
'player attributes');
server += `\nWorkspace:SetAttribute("ACC_BecakRuntime","v1.9")\n`;
...
console.log('[Becak E-Bike] Built v1.9 seamless sidewalk/road access + left mobile UI + navigation + world QC:',Buffer.byteLength(xml),'bytes');
