...
console.log('[Becak E-Bike] Built v1.30 cargo payload visuals + v1.29 adaptive left phone + v1.27 road-edge audit + v1.26 recovery + progression systems:',Buffer.byteLength(xml),'bytes');
