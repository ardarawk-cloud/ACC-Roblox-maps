...
`playerData[player]=d\n    player:SetAttribute("BecakTrips",d.Trips)\n    player:SetAttribute("BecakVersion","1.7.0")\n    local stats=Instance.new("Folder")`,
'player attributes');
server += `\nWorkspace:SetAttribute("ACC_BecakRuntime","v1.7")\n`;
...
console.log('[Becak E-Bike] Built v1.7 navigation + world QC + road-access + mobile safe-area:',Buffer.byteLength(xml),'bytes');
