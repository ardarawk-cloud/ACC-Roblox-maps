...
const bundle = `${readLua('maps/mountain-social/mountain.world.server.lua')}\n${wrapped}\nworkspace:SetAttribute('ACC_MountainCoreBundle','v4.1-realistic-scenery')`;
...
console.log('[Mountain] Injected ACC Mountain v4.1 realistic scenery into',target.file,'bytes',Buffer.byteLength(xml));
