...
const bundle = `${readLua('maps/mountain-social/mountain.world.server.lua')}\n${wrapped}\nworkspace:SetAttribute('ACC_MountainCoreBundle','v4.8-microdetail-realism')`;
...
console.log('[Mountain] Injected ACC Mountain v4.8 microdetail realism into',target.file,'bytes',Buffer.byteLength(xml));
