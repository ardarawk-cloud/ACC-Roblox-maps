...
for (const file of [phase1File, checkpointFile, ambienceFile, perfFile]) {
  if (!fs.existsSync(path.join(root,file))) throw new Error(`Missing Mountain v6 runtime module: ${file}`);
}
