...
// Preserve the existing upper mountain, but current production/QC scope is deliberately Spawn -> CP1.
// WorldLife v5.1 is intentionally held back to prevent lowland overlap while LowlandMaster owns the area.
const serverModules = [
  ...
  ['lowlandmaster','maps/mountain-social/mountain.lowlandmaster.server.lua'],
...
console.log('[Mountain] Injected ACC Mountain v5.2 lowland focus into',target.file,'bytes',Buffer.byteLength(xml));
