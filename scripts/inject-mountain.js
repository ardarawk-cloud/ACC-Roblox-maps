...
const bundle = `${readLua('maps/mountain-social/mountain.world.server.lua')}\n${wrapped}\nworkspace:SetAttribute('ACC_MountainCoreBundle','v4.6-terrain-grounding')`;
...
console.log('[Mountain] Injected ACC Mountain v4.6 terrain grounding into',target.file,'bytes',Buffer.byteLength(xml));
