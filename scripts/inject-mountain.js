...
const bundle = `${readLua('maps/mountain-social/mountain.world.server.lua')}\n${wrapped}\nworkspace:SetAttribute('ACC_MountainCoreBundle','v4.9-environmental-realism')`;
...
console.log('[Mountain] Injected ACC Mountain v4.9 environmental realism into',target.file,'bytes',Buffer.byteLength(xml));
