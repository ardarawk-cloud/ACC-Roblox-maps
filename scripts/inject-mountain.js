...
// Focus lock: Spawn -> CP1 is now authoritative. Legacy lowland polish modules are intentionally omitted
// so no second road/tree/pole/house generator can overlap this area.
...
const bundle = `${readLua('maps/mountain-social/mountain.world.server.lua')}\n${lowlandWrapped}\n${wrapped}\nworkspace:SetAttribute('ACC_MountainCoreBundle','v5.2-lowland-authoritative')`;
...
console.log('[Mountain] Injected ACC Mountain v5.2 authoritative lowland into',target.file,'bytes',Buffer.byteLength(xml));
