...
const bundle = `${readLua('maps/mountain-social/mountain.world.server.lua')}\n${wrapped}\nworkspace:SetAttribute('ACC_MountainCoreBundle','v4.4-precision-alignment')`;
...
console.log('[Mountain] Injected ACC Mountain v4.4 precision alignment into',target.file,'bytes',Buffer.byteLength(xml));
