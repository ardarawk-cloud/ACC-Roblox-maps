...
const qc=`task.delay(20,function()
 ...
 local ok=r~=nil and workspace:GetAttribute('ACC_BootstrapRuntimeOK')==true and workspace:GetAttribute('ACC_ReleaseRuntimeOK')==true and workspace:GetAttribute('ACC_SpawnGate')=='READY' and r:GetAttribute('Phase1Scope')=='SPAWN_TO_CP1_ONLY' and r:GetAttribute('TerrainFrozen')==true and r:GetAttribute('Phase1Ready')==true and r:GetAttribute('Phase1VisualReady')==true and r:GetAttribute('MountBBYAPhase1PremiumReady')==true and cp1==true
...
const releaseGated=`local deadline=os.clock()+85;repeat local r=workspace:FindFirstChild('ACC_MountainSocial');if r and r:GetAttribute('MountBBYAPhase1PremiumReady')==true then break end;if os.clock()>deadline then error('premium gate timeout')end;task.wait(.2)until false\n${release}`;
...
const servers=[item('Script','BOOT','MountBBYA_Bootstrap',bootstrap),item('Script','CORE','MountBBYA_Phase1_Core',read(files.core)),item('Script','VIS61','MountBBYA_Phase1_Visual61',read(files.compose)),item('Script','VIS65','MountBBYA_Phase1_Premium65',premium),item('Script','AMB','MountBBYA_Ambience',read(files.ambience)),item('Script','CP','MountBBYA_Checkpoint',checkpoint),item('Script','REL','MountBBYA_Release',releaseGated),item('Script','QC','MountBBYA_QC',qc)].join('');
