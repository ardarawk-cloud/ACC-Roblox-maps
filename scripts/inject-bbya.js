...
<Item class="ServerScriptService" referent="RBXBBYASERVERSCRIPTSERVICE00000001">
  ...
  <Item class="Script" referent="RBXBBYAPHASE5PREMIUMV450000000001"><Properties><bool name="Disabled">false</bool><string name="Name">BBYA_Premium_Phase_5_v4_5</string><ProtectedString name="Source"><![CDATA[${phase5Lua}]]></ProtectedString></Properties></Item>
...
console.log('[BBYA] Active build injected: Visual Rebuild v4 + Polish v4.1 + Phase 3 + Phase 4 + Phase 5 v4.5 + QC v4.3 + anchor navigation + adaptive mobile performance + premium UI systems into', target.file);
