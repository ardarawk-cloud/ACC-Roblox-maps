return {
    ...
    Version = "1.3.0-fail-closed-data-safety",
    ...
    Runtime = {
        ...
        FailClosedDataLoads = true,
        ReadOnlyOnLoadFailure = true,
        NoDefaultOverwriteOnReadFailure = true,
        PlayerFacingReadOnlyWarning = true,
    ...
    QA = {
        ...
        FailClosedDataSafetyAudit = true,
        ReadOnlyFailureModeAudit = true,
        NoBlankOverwriteAudit = true,
