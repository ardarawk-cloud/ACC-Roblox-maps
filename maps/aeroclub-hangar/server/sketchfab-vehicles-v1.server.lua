...
local CAR01_ASSET_ID = 0 -- HANGAR_CAR01_NISSAN_R34_BRIAN
local CAR02_ASSET_ID = 0 -- HANGAR_CAR02_DODGE_CHARGER_1970
local CAR03_ASSET_ID = 0 -- HANGAR_CAR03_TOYOTA_SUPRA_MK4
local CAR04_ASSET_ID = 0 -- HANGAR_CAR04_LAMBORGHINI_MURCIELAGO
local CAR05_ASSET_ID = 0 -- HANGAR_CAR05_MITSUBISHI_ECLIPSE_1995
local CAR06_ASSET_ID = 0 -- HANGAR_CAR06_HONDA_S2000
local CAR07_ASSET_ID = 0 -- HANGAR_CAR07_ECLIPSE_SPYDER
local CAR08_ASSET_ID = 0 -- HANGAR_CAR08_SUBARU_BRZ
local CAR09_ASSET_ID = 0 -- HANGAR_CAR09_NISSAN_SKYLINE_CWEST
local CAR10_ASSET_ID = 0 -- HANGAR_CAR10_CHEVY_CAMARO
local CAR11_ASSET_ID = 0 -- HANGAR_CAR11_DELOREAN
