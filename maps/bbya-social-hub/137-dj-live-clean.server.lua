...
local LIBRARY={}
local function add(map,title,id,playbackSpeed)table.insert(LIBRARY,{map=map,title=title,id=tonumber(id),playbackSpeed=tonumber(playbackSpeed)or 1,artist=map})end

for _,t in ipairs({
 {"1.Walking On Air",96983528563473},{"10. CHRISYE - PERGILAH KASIH",105877233550276},{"10A - 130 - Always Loving You",94337788677482},{"11A - 130 - 01.runaway (mumu remix)",112322493409786},{"11A - 130 - Run_away_remix",89165355590583},{"11B - 126 - People (Eelke Kleijn Extended Mix)",134057367195123},{"11B - 128 - Nadia Ali - People",91900235935901},{"1A - 128 - Dreaming (Original Mix)",115774171488936},{"2A - 130 - tru love - Viemix Remix",100162128635185},{"2A - 132 - Stadium - The Time",82993942539950},{"3A - 128 - M O M M E N T",109286172792690},{"3A - 128 - Desert Rose - Stadium Mix 2011",94547306143480},{"3A - 130 - DESTINATION CALABRIA ORI",109116552044147},{"4. Stadium Club Remix - Stars of Edger",123077675190094},{"4B - 128 - Fly Away (Main Mix)",87114365256034},{"Utopia - Baby Doll (Phatbee Edit)",136681158481930},{"Tiket - Hanya Kamu yg Bisa (Phatbee & Berco Edit)",131557279061872},{"5A - 128 - Walking On Air",93670094706108},{"5A - 128 - Walkin On Air (Matthew)",81169975667413},{"5A - 130 - dj riri - rusty guitar",123696371004403},{"5A - 130 - PULSE OF JAKARTA",74479015238422},{"5A - 131 - High Revolution - Studio 51",102620964808698},{"11A - 130 - RUN AWAY",99998363156285},{"5B - 128 - Never Fear",88925775968276}
})do add("CLUB",t[1],t[2],1)end
for _,t in ipairs({{"Wonder Girls - Nobody (ROOKIE Amapiano Edit)",105859685125263,1},{"AUDIO #135466870455541",135466870455541,1},{"AUDIO #104570664651564",104570664651564,1},{"AUDIO #126169746073506",126169746073506,NORMALIZED_175X},{"AUDIO #71255967755640",71255967755640,NORMALIZED_175X},{"AUDIO #96302475011963",96302475011963,NORMALIZED_175X},{"AUDIO #120132620242467",120132620242467,NORMALIZED_175X},{"AUDIO #132641805708328",132641805708328,NORMALIZED_175X}})do add("VIP",t[1],t[2],t[3])end
for _,t in ipairs({
 {"Tabola Bale - Kienzy x Ajun Perwira BKB EDIT",77926481439798,1},{"SOLEDAD [ DESTRA PRAYOGO ]#BKB2K25",112400686884526,1},{"MASIH DENGANMU [ DESTRA PRAYOGO ]#BKB2K25",140443777425109,1},{"MACARENA 2026 - ZHAK (BKB EDIT)",135670059308492,1},{"JANGAN TUNGGU LAMA LAMA BKB VOL 5",99406970263948,1},{"I NEED A DOCTOR 2025 - VAY BREAKS",129689050998627,1},{"I KNOW YOU WANT ME - KIN BKB EDIT",117479133947987,1},{"KUNTUL PANJANG - GERALD ATIMANG BOOTLEG",95368919127704,1},{"BANG BANG BANG - KIN EDIT",123499438012066,1},{"ANIMA BINTANG [ DESTRA PRAYOGO ]#BKB2K25",140442667497371,1},{"ANAK SINGKONG [ DESTRA PRAYOGO ]#BKB2K25",90986894139778,1},{"17.Mugwanti (Mahesa & hmp BKB Edit)",113698017406179,1},{"06. ARIA PIL KB (EANN BKB EDIT)",109573287368195,1},{"11A - 130 - RUN AWAY",99998363156285,1},{"TOR MONITOR KETUA - QMUNK AMSTRONG",105712830643792,1},{"SIK ASIK - Mail Alektra (BKB EDIT)",81832495836167,1},{"SEDIA AKU SEBELUM HUJAN - QMUNK AMSTRONG",117476404561871,1},{"POK ANI ANI - DJ VINNIE PARGOY, BILLIE KOPLO",139454814636865,1},{"PICA PICA 2 - ARIEF RASIT (BKB EDIT)",94631926635772,1},{"pararam-bkb-ipan-agstyan",99942691456392,1},{"Om Abidin - Ani Ani (Club Mix)",103410156771684,1},{"Ni De Wan Shui Qian Shan - Aldy alvaro, DJ U",106769175117849,1},{"Ni De Da An - Aldy alvaro",90741742310621,1},{"NGAPAIN REPOT (RAYEN BKB EDIT)",117103573334654,1},{"NGAPAIN REPOT (DEKA EDIT)",105840679569825,1},{"Ngapain Repot (Aldy Alvaro BKB edit)",106277277729828,1},{"MORENA BKB (HARLY EDIT)",97696234195316,1},{"I LOVE IT - KIN EDIT",131463436495955,.8},{"Jar of Hearts - Noka AxL Breakbeat Remix",90545257553901,.8},{"YOU DON'T EVEN KNOW ME STADIUM BREAKBEAT",133306911098734,.8},{"MILLION STARS STADIUM BREAKBEAT",118285103846602,.8},{"DJ TELOOR - WET GUITAR",74227363291004,.8},{"EE SAKADUNG KADING 2026",82680681349117,.8},{"BLACK HOLE - DJ TELOOR REMIX",126615725566516,.8},{"SERANA - FOR REVENGE (DJ Ugi Mekti BKB Edit)",79441401193706,.8},{"MUTIARA - IYAN.FG",117092832313612,.8},{"Kamu gak bakal tau",128236218314957,NORMALIZED_175X},{"Surga",73490528411091,NORMALIZED_175X},{"Hati",117969837722651,NORMALIZED_175X},{"Bintang jatuh",82059974893640,NORMALIZED_175X},{"Kapal tenggelam",124813032756402,NORMALIZED_175X},{"Pegangan",131317518484469,NORMALIZED_175X},{"Dalu dalu",112530372468543,NORMALIZED_175X},{"Anak kampung",128982389712711,NORMALIZED_175X}
})do add("UNDERGROUND",t[1],t[2],t[3])end
for _,t in ipairs({{"Zinyo Funkytone - Siapa Benar - Garam Cina 2025.mp3",128141893547516},{"Zinyo Funky Tone - Hatiku Bagai Terpenjara 2025.mp3",98536948000407},{"Space Melody '23 - Dj Deri Rmx",128567852049551}})do add("FUNKOT",t[1],t[2],1)end

local function parseBpm(title)for n in tostring(title):gmatch("%d%d%d")do local bpm=tonumber(n);if bpm and bpm>=80 and bpm<=200 then return bpm,"TITLE"end end;return 0,"UNKNOWN"end
for i,t in ipairs(LIBRARY)do t.index=i;local explicit=BPM_BY_ASSET[t.id];if explicit then t.bpm=explicit;t.bpmSource="CATALOG_ALIAS"else t.bpm,t.bpmSource=parseBpm(t.title)end;t.maps={t.map}end
...
local function configureFx(fx)
 fx.ECHO.Enabled=false;fx.ECHO.Delay=.22;fx.ECHO.Feedback=.55;fx.ECHO.WetLevel=-2;fx.ECHO.DryLevel=0
 fx.FILTER.Enabled=false;fx.FILTER.LowGain=4;fx.FILTER.MidGain=-8;fx.FILTER.HighGain=-24
 fx.REVERB.Enabled=false;fx.REVERB.DecayTime=2.6;fx.REVERB.Density=.8;fx.REVERB.Diffusion=.85;fx.REVERB.WetLevel=-3;fx.REVERB.DryLevel=0
...
local function freshDeck()return{trackIndex=0,title="EMPTY",artist="",assetId=0,bpm=0,bpmSource="UNKNOWN",baseSpeed=1,playbackSpeed=1,playing=false,cue=0,loaded=false,timePosition=0,timeLength=0,fx={ECHO=false,FILTER=false,REVERB=false,FLANGER=false}}end
...
local function chooseTempoRatio(sourceBpm,targetBpm)if sourceBpm<=0 or targetBpm<=0 then return nil end;local raw=sourceBpm/targetBpm;local candidates={raw,raw*2,raw*.5};local best,bestCost=nil,math.huge;for _,r in ipairs(candidates)do if r>=.72 and r<=1.38 then local cost=math.abs(math.log(r));if cost<bestCost then best=r;bestCost=cost end end end;return best end
local function syncDeck(deck)local target,_,td=deckObjects(deck);local source,_,sd=deckObjects(deck=="A"and"B"or"A");if not target or not source or not td or not sd or td.assetId<1 or sd.assetId<1 then return end;if td.bpm<=0 or sd.bpm<=0 then broadcast("SYNC NEEDS BPM • DECK "..deck);return end;local sourceTempo=sd.bpm*((source.PlaybackSpeed or 1)/(sd.baseSpeed or 1));local ratio=chooseTempoRatio(sourceTempo,td.bpm);if not ratio then broadcast("SYNC RANGE TOO FAR • "..math.floor(sourceTempo+.5).." vs "..td.bpm);return end;target.PlaybackSpeed=math.clamp((td.baseSpeed or 1)*ratio,.35,1.6);td.playbackSpeed=target.PlaybackSpeed;local targetTempo=td.bpm*(target.PlaybackSpeed/(td.baseSpeed or 1));if source.Playing and sourceTempo>0 and targetTempo>0 then local srcBeat=60/sourceTempo;local dstBeat=60/targetTempo;local phase=(source.TimePosition%srcBeat)/srcBeat;local base=math.floor(target.TimePosition/dstBeat)*dstBeat;pcall(function()target.TimePosition=math.max(0,base+phase*dstBeat)end)end;syncPlayingFlags();broadcast("SYNC • DECK "..deck.." • "..string.format("%.1f BPM",targetTempo))end
local function toggleFx(deck,name)name=string.upper(tostring(name or""));local _,_,d=deckObjects(deck);if d and d.fx[name]~=nil then d.fx[name]=not d.fx[name];applyFx(deck);broadcast("FX "..name.." "..(d.fx[name]and"ON"or"OFF").." • DECK "..deck)end end
