-- BBYA SOCIAL HUB — ROLE PANEL v8 FUNCTION-ONLY
-- Normal BBYA feature-panel compatibility/layout mutation is retired.
-- UI KERNEL v2.3 owns normal feature geometry; this file owns only authorized role management UI.
