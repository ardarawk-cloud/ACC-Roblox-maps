...
local remove=button(detail,"REMOVE ROLE",UDim2.fromOffset(10,276),UDim2.new(1,-20,0,36),C.red);local status=text(detail,"Select an online player.",UDim2.fromOffset(12,312),UDim2.new(1,-24,0,14),Enum.Font.GothamBold,8,C.muted)
