...
for _,d in ipairs({{"ARRIVAL","Arrival"},{"MAIN CLUB","MainClub"},{"VIP LEVEL","VIP"},{"QUEEN SKYBOX","Queen"},{"ROOFTOP","Rooftop"},{"BASEMENT","Basement"}}) do local b=btn(tpHolder,d[1],UDim2.new(),UDim2.new(.48,0,0,52),Color3.fromRGB(31,25,36));stroke(b,d[2]=="Basement" and CYAN or PINK,1,.55);b.MouseButton1Click:Connect(function()teleportRemote:FireServer(d[2]);menu.Visible=false end) end
