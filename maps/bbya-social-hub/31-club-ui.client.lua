...
local tpHolder=Instance.new("Frame");tpHolder.BackgroundTransparency=1;tpHolder.Position=UDim2.fromOffset(0,78);tpHolder.Size=UDim2.new(1,0,1,-78);tpHolder.Parent=teleport
...
for _,d in ipairs({{"ARRIVAL","Arrival"},{"MAIN CLUB","MainClub"},{"VIP LEVEL","VIP"},{"QUEEN SKYBOX","Queen"},{"ROOFTOP","Rooftop"},{"POOL DECK","Pool"}}) do local b=btn(tpHolder,d[1],UDim2.new(),UDim2.new(.48,0,0,52),Color3.fromRGB(31,25,36));stroke(b,d[2]=="Pool" and CYAN or PINK,1,.55);b.MouseButton1Click:Connect(function()teleportRemote:FireServer(d[2]);menu.Visible=false end) end
