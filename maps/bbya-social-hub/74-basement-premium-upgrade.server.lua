...
local function pentagram(name,center,radius)
 ...
 for i=0,4 do
  ...
  pts[i+1]=center+Vector3.new(math.cos(a)*radius,0,math.sin(a)*radius)
 end
 for i=1,5 do
  local j=((i+1)%5)+1
  beam(name.."StarEdge"..i,pts[i],pts[j],C.white,pentagrams,.20)
 end
end
pentagram("StarNorthWest",Vector3.new(-45,-1.24,-20),6.5)
