-- BBYA SOCIAL HUB — SUPPORT PURCHASE + DONATION NOTIFICATION v6.2
-- Native Roblox checkout remains the only purchase confirmation UI.
-- NEW DONATION broadcast stays compact; only SFX loudness is tuned from runtime QC.
...
local gui=Instance.new("ScreenGui");gui.Name="BBYADonationNotificationUI";gui.ResetOnSpawn=false;gui.IgnoreGuiInset=true;gui.DisplayOrder=230;gui.ZIndexBehavior=Enum.ZIndexBehavior.Sibling;gui.Parent=pg;gui:SetAttribute("NotificationAuthority","NEW_DONATION_V6_2_COMPACT_TUNED_SFX")
...
print("[BBYA] Support v6.2 online: compact notification + SFX volume 1.55")