...
local C={black=Color3.fromRGB(9,8,12),charcoal=Color3.fromRGB(25,21,28),floor=Color3.fromRGB(71,58,63),pink=Color3.fromRGB(255,42,157),blue=Color3.fromRGB(0,174,255),warm=Color3.fromRGB(255,188,122),glass=Color3.fromRGB(50,34,55),pinkBody=Color3.fromRGB(72,18,48),blueBody=Color3.fromRGB(12,52,82)}

local function part(name,size,cf,color,material,transparency,parent)
 local p=Instance.new("Part");p.Name=name;p.Anchored=true;p.CanCollide=true;p.Size=size;p.CFrame=cf;p.Color=color;p.Material=material or Enum.Material.SmoothPlastic;p.Transparency=transparency or 0;p.Parent=parent or model;return p
end
