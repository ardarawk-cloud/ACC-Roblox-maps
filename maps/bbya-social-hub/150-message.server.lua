...
local liveFrame=Instance.new("Frame");liveFrame.Size=UDim2.fromScale(1,1);liveFrame.BackgroundColor3=Color3.fromRGB(8,7,11);liveFrame.Visible=false;liveFrame.Parent=bg;local badge=lab(liveFrame,"BBYA LIVE MESSAGE",UDim2.fromScale(.06,.07),UDim2.fromScale(.88,.08),Enum.Font.GothamBlack,28,pink,Enum.TextXAlignment.Center);local msg=lab(liveFrame,"",UDim2.fromScale(.07,.20),UDim2.fromScale(.86,.48),Enum.Font.GothamBlack,52,white,Enum.TextXAlignment.Center);local from=lab(liveFrame,"",UDim2.fromScale(.10,.73),UDim2.fromScale(.80,.08),Enum.Font.GothamBold,22,gold,Enum.TextXAlignment.Center)
