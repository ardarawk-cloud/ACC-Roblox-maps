...
p("LaptopStand",Vector3.new(5,.25,2.4),CFrame.new(0,-7.7,34),C.metal,Enum.Material.Metal);local laptopCF=CFrame.new(0,-6.3,35)*CFrame.Angles(math.rad(10),math.rad(180),0);p("LaptopScreen",Vector3.new(5,3,.25),laptopCF,C.dark,Enum.Material.Metal);neon("LaptopDisplay",Vector3.new(4.5,2.5,.08),laptopCF*CFrame.new(0,0,-.165),C.blue)
...
-- premium lounges on left/right
for _,x in ipairs({-46,46}) do p("SideBench"..x,Vector3.new(14,2.2,26),CFrame.new(x,-13.8,3),C.metal,Enum.Material.Metal);p("SofaBack"..x,Vector3.new(14,4,2),CFrame.new(x,-11.7,14),C.dark,Enum.Material.SmoothPlastic);neon("BenchGlow"..x,Vector3.new(12,.15,.18),CFrame.new(x,-12.6,-9),x<0 and C.blue or C.yellow) end
-- BAR: directly opposite DJ, against rear/south wall (not beside DJ)
...
print("[BBYA] Underground: DJ north, bar opposite on south/rear wall, premium side lounges")