...
-- Core legacy interactions retained only where no modern Floor 1 feature replaces them.
...
print("[BBYA] social core online; legacy Floor 1 photo/salon/DJ prompts removed")