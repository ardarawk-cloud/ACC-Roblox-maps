-- ACC Mountain Social Adventure — POS 1 trailhead rebuild v4.0
...
local base=Vector3.new(-55,48,-30)
...
-- POS 1 is the end of public-road feeling and the real start of hiking.
mk("TrailheadClearing",Vector3.new(92,3,76),CFrame.new(base-Vector3.new(0,2.5,0)),Enum.Material.Ground,Color3.fromRGB(100,84,62),camp)
mk("SmallParking",Vector3.new(52,2,30),CFrame.new(base+Vector3.new(36,-1.4,17)),Enum.Material.Gravel,Color3.fromRGB(105,101,91),camp)
-- Ranger/post hut.
...
mk("HutRoof",Vector3.new(34,2,24),CFrame.new(h+Vector3.new(0,13,0)),Enum.Material.CorrugatedMetal,Color3.fromRGB(67,72,68),camp)
local counter=mk("RegistrationDesk",Vector3.new(11,4,3),CFrame.new(h+Vector3.new(0,3,-10)),Enum.Material.WoodPlanks,Color3.fromRGB(85,62,42),camp)
-- Trailhead gate.
...
-- Route board emphasizes that summit is still far away.
...
-- A modest rest area, not a spawn hub.
local fireBase=mk("Pos1Campfire",Vector3.new(6,1,6),CFrame.new(base+Vector3.new(18,1,27)),Enum.Material.Slate,Color3.fromRGB(72,70,65),camp);local fire=Instance.new("Fire");fire.Size=4;fire.Heat=6;fire.Parent=fireBase
...
-- Do not move MountainSpawn here. Spawn must remain in the village.
root:SetAttribute("BasecampVersion","4.0")
root:SetAttribute("BasecampRole","POS1_TRAILHEAD")
print("[ACC] POS 1 trailhead v4 ready")
