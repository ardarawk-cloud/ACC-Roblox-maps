-- BBYA Music Vault mobile panel v1.0
...
open.Name="MusicButton";open.Size=UDim2.fromOffset(48,48);open.AnchorPoint=Vector2.new(1,1);open.Position=UDim2.new(1,-18,1,-76)
...
frame.Name="Panel";frame.AnchorPoint=Vector2.new(1,1);frame.Position=UDim2.new(1,-16,1,-132);frame.Size=UDim2.fromOffset(330,390)
...
local nowTitle=Instance.new("TextLabel");nowTitle.Size=UDim2.new(1,-18,0,44);nowTitle.Position=UDim2.fromOffset(9,7);nowTitle.BackgroundTransparency=1;nowTitle.Text="NOW PLAYING\nBBYA 24/7";nowTitle.TextColor3=Color3.new(1,1,1);nowTitle.TextWrapped=true;nowTitle.Font=Enum.Font.GothamBold;nowTitle.TextSize=13;nowTitle.TextXAlignment=Enum.TextXAlignment.Left;nowTitle.TextYAlignment=Enum.TextYAlignment.Top;nowTitle.Parent=now
...
local function ctl(txt,cb,w)
 local b=Instance.new("TextButton");b.Size=UDim2.fromOffset(w or 68,38);b.BackgroundColor3=CARD;b.Text=txt;b.TextColor3=Color3.new(1,1,1);b.Font=Enum.Font.GothamBold;b.TextSize=12;b.Parent=controls;corner(b,9);b.Activated:Connect(cb);return b
end
...
local function tab(txt,mode)
 local b=Instance.new("TextButton");b.Size=UDim2.fromOffset(94,34);b.BackgroundColor3=CARD;b.Text=txt;b.TextColor3=Color3.new(1,1,1);b.Font=Enum.Font.GothamBold;b.TextSize=11;b.Parent=tabs;corner(b,9);b.Activated:Connect(function()control:FireServer("MODE",mode)end)
end
...
for _,sub in ipairs(subs)do
 local b=Instance.new("TextButton");b.BackgroundColor3=CARD;b.Text=sub:gsub("_"," ");b.TextColor3=Color3.new(1,1,1);b.Font=Enum.Font.GothamBold;b.TextSize=10;b.TextWrapped=true;b.Parent=scroll;corner(b,9);b.Activated:Connect(function()control:FireServer("SUBGENRE",sub)end)
end
...
print("[BBYA] Music Vault mobile panel loaded")