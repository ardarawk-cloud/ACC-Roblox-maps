...
local missing={}
for _,check in ipairs(checks) do if not check.instance then table.insert(missing,check.label) end end

local legacy={}
for _,name in ipairs({
 "BBYA Front Lobby v4.8","BBYA Visual v1.2","BBYA Social Systems","BBYA Arrival Neon Box",
 "BBYA Mega Architecture v2","BBYA Master Plan Completion v3"
}) do
