-- BBYA SOCIAL HUB — PREMIUM EXTERIOR / REFERENCE-ALIGNED PASS
-- This layer only adds secondary exterior detail to the architecture in 10-architecture.lua.
-- Do not duplicate primary building masses, floors, roof slabs, or core facade walls here.

-- =========================================================
-- CENTRAL SOCIAL / ARRIVAL FACADE DETAIL
-- =========================================================
-- Keep the center visually open. Use glass and thin framing only.
...
-- Thin vertical brand fins only. The main BBYA wordmark already belongs to architecture.
for _,x in ipairs({-31,-24,-17,-10,-3,4}) do
    neon(A2,"BRAND TOWER FIN "..x,Vector3.new(.15,20,.15),CFrame.new(x,28,-9.1),x%2==0 and C.cyan or C.pink)
end

-- =========================================================
-- LEFT MULTI-LEVEL CLUB WING DETAIL
-- =========================================================
-- Balcony edge treatment only; main slabs are already defined in architecture.
for _,cfg in ipairs({
...
-- Vertical curtain-wall rhythm keeps the left tower premium without adding another fake shell.
...
-- =========================================================
-- RIGHT VIP WING DETAIL
-- =========================================================
-- Framed glass frontage only; the structural VIP wing is defined in architecture.
...
-- Clear architectural portal. Keep it light so it does not fight the main BBYA facade.
...
-- =========================================================
-- ROOFTOP RESORT DETAIL
-- =========================================================
-- Warm resort frames. No second nightclub shell and no duplicate roof mass.
...
-- Keep only one rooftop identity sign, attached to the terrace edge.
...
-- Infinity edge accent only; basin and primary glass are defined in architecture.
...
-- Planters frame the approach but leave the center axis completely clear.
...
workspace:SetAttribute("BBYAPremiumExterior","REFERENCE_ALIGNED_PASS_3")
