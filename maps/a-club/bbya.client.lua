-- BBYA Social Hub v1.5 client: mobile UI + 24/7 music control panel shell
...
local open=Instance.new("TextButton");open.Size=UDim2.fromOffset(72,34);open.Position=UDim2.new(0,10,1,-46);open.Text="BBYA";open.Font=Enum.Font.GothamBold;open.TextSize=18;open.BackgroundColor3=Color3.fromRGB(35,18,48);open.TextColor3=Color3.new(1,1,1);open.Parent=gui;Instance.new("UICorner",open).CornerRadius=UDim.new(0,8)
local frame=Instance.new("Frame");frame.Size=UDim2.fromOffset(276,330);frame.Position=UDim2.new(0,10,0,92);frame.BackgroundColor3=Color3.fromRGB(18,14,26);frame.BackgroundTransparency=.06;frame.Visible=false;frame.ClipsDescendants=true;frame.Parent=gui;Instance.new("UICorner",frame).CornerRadius=UDim.new(0,10)
...
-- MUSIC PANEL: reads existing BBYA music system attributes/sound; does not replace the established playlist engine.
local music=Instance.new("Frame");music.Name="MusicPanel";music.Size=UDim2.fromOffset(260,118);music.Position=UDim2.new(1,-270,1,-130);music.BackgroundColor3=Color3.fromRGB(16,13,24);music.BackgroundTransparency=.08;music.Parent=gui;Instance.new("UICorner",music).CornerRadius=UDim.new(0,10)
...
local mute=Instance.new("TextButton");mute.Size=UDim2.fromOffset(72,30);mute.Position=UDim2.fromOffset(8,78);mute.Text="MUTE";mute.Font=Enum.Font.GothamBold;mute.TextSize=13;mute.TextColor3=Color3.new(1,1,1);mute.BackgroundColor3=Color3.fromRGB(50,32,68);mute.Parent=music;Instance.new("UICorner",mute).CornerRadius=UDim.new(0,7)
local volDown=Instance.new("TextButton");volDown.Size=UDim2.fromOffset(46,30);volDown.Position=UDim2.fromOffset(88,78);volDown.Text="VOL-";volDown.Font=Enum.Font.GothamBold;volDown.TextSize=12;volDown.TextColor3=Color3.new(1,1,1);volDown.BackgroundColor3=Color3.fromRGB(50,32,68);volDown.Parent=music;Instance.new("UICorner",volDown).CornerRadius=UDim.new(0,7)
local volUp=Instance.new("TextButton");volUp.Size=UDim2.fromOffset(46,30);volUp.Position=UDim2.fromOffset(140,78);volUp.Text="VOL+";volUp.Font=Enum.Font.GothamBold;volUp.TextSize=12;volUp.TextColor3=Color3.new(1,1,1);volUp.BackgroundColor3=Color3.fromRGB(50,32,68);volUp.Parent=music;Instance.new("UICorner",volUp).CornerRadius=UDim.new(0,7)
local hide=Instance.new("TextButton");hide.Size=UDim2.fromOffset(58,30);hide.Position=UDim2.fromOffset(192,78);hide.Text="HIDE";hide.Font=Enum.Font.GothamBold;hide.TextSize=12;hide.TextColor3=Color3.new(1,1,1);hide.BackgroundColor3=Color3.fromRGB(50,32,68);hide.Parent=music;Instance.new("UICorner",hide).CornerRadius=UDim.new(0,7)
...
print("[BBYA] v1.5 mobile UI + 24/7 music panel loaded")