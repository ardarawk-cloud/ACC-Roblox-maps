-- [A5] BAR ROOM
local A5=registerZone("A5","BAR ROOM","G",Vector3.new(-72,7,52),Vector3.new(32,14,50))
...
program(A5,"BAR PROGRAM",Vector2.new(28,44),Vector3.new(-72,.62,52),C.gold)
landing(A5,"BAR LANDING",Vector3.new(-72,.64,60),C.gold)
label(A5,"BAR LOBBY DOOR","BAR",CFrame.new(-72,8,77.9),Vector3.new(12,3,.25),C.gold,Enum.NormalId.Front)
