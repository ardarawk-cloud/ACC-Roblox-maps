-- [A6] CHILL LOUNGE
local A6=registerZone("A6","CHILL LOUNGE","G",Vector3.new(72,7,52),Vector3.new(32,14,50))
...
program(A6,"CHILL PROGRAM",Vector2.new(28,44),Vector3.new(72,.62,52),C.cyan)
landing(A6,"CHILL LANDING",Vector3.new(72,.64,60),C.cyan)
label(A6,"CHILL LOBBY DOOR","CHILL LOUNGE",CFrame.new(72,8,77.9),Vector3.new(17,3,.25),C.cyan,Enum.NormalId.Front)
