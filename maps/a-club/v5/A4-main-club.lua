...
local A4=registerZone("A4","CLUB FACILITY / DANCE HALL","G",Vector3.new(0,9,9),Vector3.new(108,18,146))
-- Club is one facility inside BBYA Social Hub, not the building's primary identity.
...
program(A4,"CLUB DANCE FLOOR",Vector2.new(100,118),Vector3.new(0,.62,9),C.pink)
