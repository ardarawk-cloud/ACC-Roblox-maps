-- BBYA Top Supporter mobile panel v1.0
...
gui.Name="BBYA_SupportPanel";gui.ResetOnSpawn=false;gui.DisplayOrder=29;gui.Parent=player:WaitForChild("PlayerGui")
local BG=Color3.fromRGB(13,12,19);local CARD=Color3.fromRGB(31,25,39);local PINK=Color3.fromRGB(255,82,205);local GOLD=Color3.fromRGB(255,211,90);local CYAN=Color3.fromRGB(56,216,255)
...
local open=Instance.new("TextButton");open.Size=UDim2.fromOffset(48,48);open.AnchorPoint=Vector2.new(1,1);open.Position=UDim2.new(1,-74,1,-76);open.Text="♛";open.TextSize=23;open.TextColor3=GOLD;open.BackgroundColor3=BG;open.Font=Enum.Font.GothamBlack;open.Parent=gui;corner(open,14);stroke(open)
local frame=Instance.new("Frame");frame.AnchorPoint=Vector2.new(1,1);frame.Position=UDim2.new(1,-16,1,-132);frame.Size=UDim2.fromOffset(350,430);frame.BackgroundColor3=BG;frame.Visible=false;frame.Parent=gui;corner(frame,16);stroke(frame)
...
local function row(data)
 local c=Instance.new("Frame");c.Size=UDim2.new(1,-4,0,44);c.BackgroundColor3=CARD;c.Parent=scroll;corner(c,9)
 local t=Instance.new("TextLabel");t.Size=UDim2.new(1,-12,1,0);t.Position=UDim2.fromOffset(6,0);t.BackgroundTransparency=1;t.Text=string.format("#%d   %s   •   R$%d",data.rank,data.name,data.amount);t.TextColor3=Color3.new(1,1,1);t.Font=Enum.Font.GothamBold;t.TextSize=11;t.TextXAlignment=Enum.TextXAlignment.Left;t.Parent=c
end
...
print("[BBYA] Top Supporter avatar panel loaded")